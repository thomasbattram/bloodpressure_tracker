"""
Django settings for bloodpressure_tracker project.
...
SECRET_KEY = 'django-insecure-!o$xkpz-anv(3xd+06*0pddxnybzn*isfhh6q!u008y$u!)9h)'
...
ROOT_URLCONF = 'bloodpressure_tracker.urls'
...
WSGI_APPLICATION = 'bloodpressure_tracker.wsgi.application'
